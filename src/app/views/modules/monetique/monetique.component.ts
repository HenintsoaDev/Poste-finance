...
@Component({
  selector: 'app-monetique',
  templateUrl: './monetique.component.html',
  styleUrls: ['./monetique.component.scss']
})
export class MonetiqueComponent extends Translatable implements OnInit {
    ...
    constructor(private router: Router,private route: ActivatedRoute,private menuService: MenuService) {
        ...
        this.router.events.subscribe(() => {
            this.isModule = (this.router.url === '/MN' );
